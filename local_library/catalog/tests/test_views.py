...
class AuthorCreateViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_user1 = User.objects.create_user(
            username='testuser1', password='1HJ1vRV0Z&3iD')
        ...
        test_user1.user_permissions.add(permAddBook)
    ...
    def test_url_accessible_when_user1_logged_in(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('author-create'))
        self.assertEqual(response.status_code, 200)
       
    def test_forbidden_if_no_perms(self):
        login = self.client.login(username='testuser1', password='1HJ1vRV0Z&3iD')
        response = self.client.get(reverse('author-create'))
        self.assertEqual(response.status_code, 403)
