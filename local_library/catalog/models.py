...
class BookInstance(models.Model):
    """UUIDField is used to set id field as the primary_key for this model. Allocates a globally unique value for each instance."""
    ...
    @property
    def is_overdue(self):
        """Determines if book is overdue based on due date and current date"""
